...
<html>
<head>
<title>PlanMyTrip | Confirmation </title>
...
<div class="banner-1 ">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;"><b> PlanMyTrip</b></h1>
	</div>
</div>
<!--- /banner-1 ---->
<!--- contact ---->
