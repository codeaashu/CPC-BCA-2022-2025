...
<title>DriveFirst | Car Listing</title>
<!--Bootstrap -->
...
<!--Page Header-->
<section class="page-header listing_page" style="background-color: black;">
  <div class="container" >
  ...
  <!-- Dark Overlay-->
  <div class="dark-overlay" style="background-color:"></div>
</section>
<!-- /Page Header--> 
