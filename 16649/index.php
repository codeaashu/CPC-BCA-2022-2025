...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2> <span style="font-weight:700"><span>DriveFirst</span>"Reliable Rides. Remarkable Service."</span></h2>
      <p>With DriveFirst, car rentals are simple, fast, and dependable — every time, everywhere.</p>
    </div>
    <div class="row"> 
