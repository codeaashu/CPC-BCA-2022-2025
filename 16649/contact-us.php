...
<title>DriveFirst|| Contact Us Page</title>
<!--Bootstrap -->
    ...
    <div  class="row">
      <div class="col-md-6">
        ...
        <form action="contact-us.php" method="POST" id="contactForm">
            ...
            <input type="hidden" name="access_key" value="0891fbd1-c382-4651-a722-e90c1384b94e">

            
           <div class="form-group">
  <label class="control-label">Full Name <span>*</span></label>
  <input type="text" name="fullname" class="form-control white_bg" id="fullname"  >
  <span class="error-msg text-danger" id="fullnameError"></span>
</div>
...
<div class="form-group">
  ...
  <input type="text" name="contactno" class="form-control white_bg" id="phonenumber"   maxlength="10" pattern="[0-9]+">
  <span class="error-msg text-danger" id="phoneError"></span>
</div>

<div class="form-group">
  <label class="control-label">Message <span>*</span></label>
  <textarea class="form-control white_bg" name="message" rows="4"   id="message"></textarea>
  <span class="error-msg text-danger" id="messageError"></span>
</div>
...
document.getElementById("contactForm").addEventListener("submit", function(e) {
  ...
  if (!/^[a-zA-Z ]+$/.test(name)) {
    document.getElementById("fullnameError").innerText = "Name should contain only letters and spaces.";
    hasError = true;
  }
