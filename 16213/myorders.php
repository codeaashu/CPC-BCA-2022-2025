                ...
                if (isset($_SESSION["uid"])) {
                    ...
                    if (mysqli_num_rows($query) > 0) {
                        ...
                        <div class="subtotal cf">
                            <ul>
                            <li class="totalRow"><span class="label">Subtotal</span><span class="value">Rs. '.$prev_total.'</span></li>
                            
                                <li class="totalRow"><span class="label">Shipping</span><span class="value">Rs. 0.00</span></li>
                            
                                    <li class="totalRow"><span class="label">Tax</span><span class="value">Rs. 0.00</span></li>
                                    <li class="totalRow final"><span class="label">Total</span><span class="value">Rs. '.$prev_total.'</span></li>
