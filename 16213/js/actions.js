$(document).ready(function(){
	...
	*/
    ...
    // Custom validation for name and mobile
    var fName = $("#f_name").val().trim();
    var lName = $("#l_name").val().trim();
    ...
    if (!mobileRegex.test(mobile)) {
        alert('Mobile number must be 10 digits and start with 9, 8, 7, or 6.');
        event.preventDefault();
        return false;
    }
    // If all validations pass, continue with AJAX
    $(".overlay").show();
    $.ajax({
        url : "register.php",
        method : "POST",
