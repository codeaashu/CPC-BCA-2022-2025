...
if (isset($_POST['reg_user'])) {
  ...
  $username = trim(mysqli_real_escape_string($db, $_POST['admin_name']));
  $email = trim(mysqli_real_escape_string($db, $_POST['admin_email']));
  ...
  elseif (strlen($password_1) < 6) { array_push($errors, "Password must be at least 6 characters"); }
...
if (isset($_POST['login_admin'])) {
  $admin_username = trim(mysqli_real_escape_string($db, $_POST['admin_username']));
