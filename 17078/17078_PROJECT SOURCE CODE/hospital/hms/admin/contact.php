...
$errors = [];
if (!preg_match("/^[6-9][0-9]{9}$/", $mobnum)) {
...
?>
                    ...
                    <div class="form-group">
					  ...
					  <input type="text" id="mobnum" name="mobnum" class="form-control"  placeholder="Enter Patient Contact no" required="true" maxlength="10" pattern="[0-9]+">
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const contact = document.getElementById('mobnum');
